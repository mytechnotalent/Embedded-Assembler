 ...
 *
 * DESCRIPTION:
 * This file contains the assembly code for functions
...
__start:
  BL   logical_shift_left                                  // call function

  BL   logical_shift_right                                 // call function

  BL   arithmetic_shift_right                              // call function

  BL   rotate_right                                        // call function

  B    .                                                   // branch infinite loop

/**
 * @brief  Logical shift left function to demonstrate an LSL instruction.
 *
 *         This function demonstrates a LSL instruction.
 *
 * @param  None
 * @retval None
 */
.type logical_shift_left, %function
logical_shift_left:
  PUSH {LR}                                                // push return address onto stack
  LDR  R0, =0b00000000000000000000000000000001             // move 0x01 into R0
  LSL  R0, #0x01                                           // logical shift left 0x01, multiply by 2, LSB gets 0
  POP  {LR}                                                // pop return address from stack
  BX   LR                                                  // return to caller

/**
 * @brief  Logical shift right function to demonstrate an LSR instruction.
 *
 *         This function demonstrates a LSR instruction.
 *
 * @param  None
 * @retval None
 */
.type logical_shift_right, %function
logical_shift_right:
  PUSH {LR}                                                // push return address onto stack                                     
  LDR  R0, =0b00000000000000000000000000000010             // move 0x02 into R0
  LSR  R0, #0x01                                           // logical shift right 0x01, integer divide by 2, MSB gets 0
  POP  {LR}                                                // pop return address from stack
  BX   LR                                                  // return to caller

/**
 * @brief  Arithmetic shift right function to demonstrate an ASR instruction.
 *
 *         This function demonstrates an ASR instruction.
 *
 * @param  None
 * @retval None
 */
arithmetic_shift_right:
  PUSH {LR}                                                // push return address onto stack 
  LDR  R0, =0b10000000000000000000000000000010             // move 0x80000002 into R0
  ASR  R0, #0x01                                           // arithmetic shift right 0x01, integer divide by 2, MSB preserves sign
  POP  {LR}                                                // pop return address from stack
  BX   LR                                                  // return to caller

/**
 * @brief  Rotate right function to demonstrate an ASR instruction.
 *
 *         This function demonstrates an ROR instruction.
 *
 * @param  None
 * @retval None
 */
rotate_right:
  PUSH {LR}                                                // push return address onto stack  
  LDR  R0, =0b00000000000000000000000000000010             // move 0x02 into R0
  ROR  R0, #0x01                                           // rotate right 0x01, multiply by 2, LSB gets original MSB value
  POP  {LR}                                                // pop return address from stack
  BX   LR                                                  // return to caller
